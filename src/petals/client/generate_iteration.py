...
class IterationLevelGenerationMixin(GenerationMixin):
    ...
    def generate(
        ...
        if is_greedy_gen_mode:
            ...
            # this is where we made some changes, remove original greedy_search()
            # to our own implementation of iteration_level_greedy_search(). Chen at Jul-17-2024
            # note that Petals use greedy search by default
            # other generation strategies have not been supported yet.
            return self.iteration_level_greedy_search(
                input_ids,
                logits_processor=logits_processor,
