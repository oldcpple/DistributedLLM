...
class BloomBlock(nn.Module):
    ...
    def forward(
        ...
        # it does not change the shape of hidden states
        ...
        for i in range(batch_size):
            ...
            tr2 = time.time()
            print('---------------------------------')
            print('real attention: {}'.format(tr2 - tr1))
            print('all attention: {}'.format(tr2 - tr0))
            print('---------------------------------')
        ...
        te = time.time()
        print('******************************')
        print('attention time: {}'.format(te - ts))
        ...
        te = time.time()
        print('other ops time: {}'.format(te - ts + ft))
        print('******************************')
...
class BloomForCausalLM(BloomPreTrainedModel):
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        transformer_outputs, timestamp = self.transformer(
            input_ids,
            iteration_info,
            past_key_values=past_key_values,
            attention_mask=attention_mask,
        ...
        te = time.time()
        print('lm_head time: {}'.format(te - ts))

        if not return_dict:
            output = (lm_logits,) + transformer_outputs[1:]
            return ((loss,) + output) if loss is not None else output

        c = CausalLMOutputWithCrossAttentions(
            loss=loss,
            logits=lm_logits,
